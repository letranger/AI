...
df = pd.read_csv('/Users/letranger/Dropbox/TNFSH/[TNFSH]AI選修/113學年度/3yscores.csv')
print(df.columns)
print(df.head())
...
#+RESULTS:
#+begin_example
Index(['Year', 'Class', '10ASub1', '10ASub2', '10ASub3', '10BSub1', '10BSub2',
       '10BSub3', '11ASub1', '11ASub2', '11ASub3', '11BSub1', '11BSub2',
       '11BSub3', '12ASub1', '12ASub2', '12ASub3', '12BSub1', '12BSub2',
       '12BSub3', 'TestNG3', 'TestSG3', '第一次模擬考排名_自然組', '第二次模擬考排名_社會組',
       '第二次模擬考排名_自然組', '第二次模擬考排名_社會組.1', '第三次模擬考排名_自然組', '第三次模擬考排名_社會組',
       '第四次模擬考排名_醫農', '第四次模擬考排名_理工', '第四次模擬考排名_社會', '第五次模擬考排名_醫農',
       '第五次模擬考排名_理工', '第五次模擬考排名_社會', '第六次模擬考排名_醫農', '第六次模擬考排名_理工',
       '第六次模擬考排名_社會', '學校', '入學管道'],
      dtype='object')
   Year Class  10ASub1  10ASub2  ...  第六次模擬考排名_理工  第六次模擬考排名_社會        學校  入學管道
0  2019    A1       31       38  ...            -            0         -     -
1  2019    A1       58       49  ...            -            0  國立臺灣師範大學  考試分發
2  2019    A1       32       43  ...            -            -      銘傳大學  考試分發
3  2019    A1       55       46  ...            -           36  國立臺灣師範大學  考試分發
4  2019    A1       79       74  ...            -            -    國立成功大學  個人申請
